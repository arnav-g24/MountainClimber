...
public class MapTester
{
    ...
    {        
        ...
        System.out.println(map.findMin());
        
		map.drawMap(g);
//		testDrawPath(map, g);			//draws a path from west to east
		testBestPath(map, g);			//draws all possible paths from west to east in red; highlights best path in yellow
    }
    ...
    public static void testDrawPath(MapIllustrator map, Graphics g) {
        ...
        g.setColor(Color.YELLOW); //can set the color of the 'brush' before drawing, the method doesn't need to worry about it
